            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
              <div>
                <h1 className="text-2xl font-semibold text-gray-800 mb-2">
                  {isViewOnly ? 'View Order' : isDraft ? 'View Order' : 'Review Order'} #{order_id}
                </h1>
                <div className="text-sm text-gray-500">
                  <a href="#" className="text-gray-500 hover:text-gray-700">Dashboard</a> / Orders / {isViewOnly || isDraft ? 'View' : 'Review'}
                </div>
                {successMessage && (
...
export default EditOrderChannel;